                    ...
                    <tr className="text-gray-400/50 uppercase border-b-[1px] border-[#56577A]">
                        {Array.from({ length: columns }).map((_, colIdx) => (
                            <th key={colIdx} className="py-3 text-center ">
                                <div className="h-3 bg-gray-300/50 dark:bg-gray-700/50 rounded w-3/4 mx-auto pulse" />
                            </th>
                        ))}
                    </tr>
                </thead>
                        ...
                        >
                            {Array.from({ length: columns }).map((_, colIdx) => (
                                <td key={colIdx} className="py-5 text-center">
                                    <div className="h-3 bg-gray-300/50 dark:bg-gray-700/50 rounded w-2/3 mx-auto pulse" />
                                </td>
                            ))}
                        </tr>
                    ))}
