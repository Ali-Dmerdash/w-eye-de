...
export default function Header() {
  ...
  return (
    <>
      <div
        className={`fixed inset-0 bg-black/50 dark:bg-black/80 z-30 sm:hidden transition-opacity duration-300 ${isMobileOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
