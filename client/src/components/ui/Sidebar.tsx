...
export default function Sidebar() {
  ...
  return (
    <>
      <div
        id="sidebar"
        className={`fixed font-mulish z-[4854586] top-0 left-0 h-screen bg-[#1d2328] border-r border-gray-800 transition-all duration-300 rounded-e-3xl ${isCollapsed ? "w-16" : "w-64"
          } ${isMobileOpen ? "translate-x-0" : "-translate-x-full"} sm:translate-x-0`}
      >
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div
            className={`flex items-center ${isCollapsed ? "justify-center px-2 py-4" : "px-6 py-4"
              }`}
          >
            {isCollapsed ? (
              <Image
          ...
          {/* User Profile */}
          <div
            className={`flex items-center ${isCollapsed ? "justify-center px-2" : "px-6"
          ...
          {/* Navigation */}
          <nav
            className={`flex-1 pt-1 ${isCollapsed ? "px-2" : "px-4"
          ...
          <div className={`group px-4 mt-auto mb-5 ${isCollapsed ? "px-5" : ""}`}>
            ...
            >
              <div
                className={`p-3 rounded-full ${isCollapsed
                    ? ""
