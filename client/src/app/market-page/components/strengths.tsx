...
export default function Strengths() {
  ...
  const strengths: string[] | undefined = marketData?.swot_analysis?.strengths
  ...
  return (
    <>
      <div
        ...
        onClick={() => hasStrengths && setModalOpen(true)}
        title={hasStrengths ? "Click for more details" : undefined}
      >
        {/* Background Pattern */}
        <div className="absolute top-0 right-0 w-20 h-20 opacity-10">
          <div className="w-full h-full bg-green-300 rounded-full transform translate-x-6 -translate-y-6"></div>
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="All Strengths">
        {hasStrengths ? (
