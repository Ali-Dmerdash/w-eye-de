...
export default function Threats() {
  ...
  if (isLoading) {
    return (
        <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl shadow-lg border border-orange-200 dark:border-orange-800/30 p-6 h-full flex flex-col">
          <div className="animate-pulse">
            {/* Header skeleton */}
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-orange-200 dark:bg-orange-800/50 rounded-xl"></div>
              <div>
                <div className="h-5 w-20 bg-orange-200 dark:bg-orange-800/50 rounded mb-2"></div>
                <div className="h-3 w-16 bg-orange-100 dark:bg-orange-900/30 rounded"></div>
              </div>
            </div>
            ...
            <div className="flex-grow flex items-center justify-center">
              <div className="text-center space-y-3">
                <div className="w-12 h-12 bg-orange-200 dark:bg-orange-800/50 rounded-full mx-auto"></div>
                <div className="space-y-2">
                  <div className="h-3 w-32 bg-orange-100 dark:bg-orange-900/30 rounded mx-auto"></div>
                  <div className="h-3 w-28 bg-orange-100 dark:bg-orange-900/30 rounded mx-auto"></div>
                </div>
              </div>
            </div>
          </div>
