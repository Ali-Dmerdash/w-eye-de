...
export default function Weaknesses() {
  ...
  if (isLoading) {
    return (
        <div className="bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20 rounded-2xl shadow-lg border border-red-200 dark:border-red-800/30 p-6 h-full flex flex-col">
          <div className="animate-pulse">
            {/* Header skeleton */}
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-red-200 dark:bg-red-800/50 rounded-xl"></div>
              <div>
                <div className="h-5 w-24 bg-red-200 dark:bg-red-800/50 rounded mb-2"></div>
                <div className="h-3 w-20 bg-red-100 dark:bg-red-900/30 rounded"></div>
              </div>
            </div>
            ...
            <div className="flex-grow flex items-center justify-center">
              <div className="text-center space-y-3">
                <div className="w-12 h-12 bg-red-200 dark:bg-red-800/50 rounded-full mx-auto"></div>
                <div className="space-y-2">
                  <div className="h-3 w-36 bg-red-100 dark:bg-red-900/30 rounded mx-auto"></div>
                  <div className="h-3 w-32 bg-red-100 dark:bg-red-900/30 rounded mx-auto"></div>
                </div>
              </div>
            </div>
          </div>
